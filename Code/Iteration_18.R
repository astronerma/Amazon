...
subs <- as.data.frame(matrix(NA,ncol=4,nrow=nrow(test)))
names(subs) <- c("s10","s12","s13","s15")
...
#weights <- c(0.82459,0.86179,0.78829,0.83817) 

prediction_test<-apply(subs,1,mean)
subs$mean <- apply(subs,1,mean)
